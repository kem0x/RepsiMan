...
cp "$root/web/leaderboard-worker.js" "$output_dir/_worker.js"
cp "$root/web/og.png" "$output_dir/og.png"
cp "$root/web/robots.txt" "$output_dir/robots.txt"
cp "$root/web/sitemap.xml" "$output_dir/sitemap.xml"
cp "$root/third_party/openbios/openbios.bin" "$output_dir/openbios.bin"
cp "$root/third_party/openbios/openbios-fastboot.bin" "$output_dir/openbios-fastboot.bin"
cp "$root/third_party/openbios/LICENSE" "$output_dir/OPENBIOS-LICENSE.txt"
mkdir -p "$output_dir/assets"
cp "$root/web/assets/title-logo-recompiled.png" "$output_dir/assets/title-logo-recompiled.png"
